...
class FG_Pickups_Dependencies {
	...
	protected function get_dependency_errors() {
		...
		if ( ! $cmb2_met ) {
			$errors[] = sprintf(
				__( 'The FremeditiGuitars - Pickups plugin requires <a href="%s">CMB2</a> to be installed and active.', 'fg-pickups' ),
	...
	public function deactivate_self() {
		deactivate_plugins( plugin_basename( FG_PICKUPS_PLUGIN_BASENAME ) );
		unset( $_GET['activate'] );
	}
